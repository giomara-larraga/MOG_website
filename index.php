                ...
                <div class="all_feature_color">
                  <div class="sub-item">
                    ...
                    <div class="feature_btn">
                      <a href="seminar.php">Read More</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="all_feature_color">
                  <div class="sub-item">
                    ...
                    <div class="feature_btn">
                      <a href="publications.php">Read More</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="all_feature_color">
                  <div class="sub-item">
                    ...
                    <div class="feature_btn">
                      <a href="software.php">Read More</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="witr_button_area">
                <div class="witr_btn_style mr">
                  <div class="witr_btn_sinner">
                    <a href="our_group_in_brief.php" class="witr_btn"
                      >More About Us
                    </a>
                  </div>
                </div>
              ...
              <div class="witr_islidess_slick project_active">
                ...
                <div class="item_pos col-lg-12">
                  <div class="witr_single_pslide">
                    <div class="witr_pslide_image">
                      <img
                        src="img/gallery/DESDEO-team.JPG"
                        alt="DESDEO team"
                      />
                    </div>
                  </div>
                ...
                <div class="item_pos col-lg-12">
                  <div class="witr_single_pslide">
                    <div class="witr_pslide_image">
                      <img
                        src="img/gallery/IMG_20210617_204017.jpg"
                        alt="image"
                      />
                    </div>
                  </div>
